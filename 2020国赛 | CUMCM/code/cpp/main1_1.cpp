...
weather hot = {8, 6}; // 水消耗、食物消耗 
weather storm = {10, 10};
weather sun = {5, 7}; 
cost waters = {3, 5}; // 水的重量、价格
cost foods = {2, 10};// 食物的重量、价格
int wea[35]; // 天气，0晴朗、1高温、2风暴
